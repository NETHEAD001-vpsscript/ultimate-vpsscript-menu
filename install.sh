...
declare -a ports_to_check=(22 80 443 8080 8443 9443 53 109 3303 143 8888 8181 8282 8383 7100 7200 7300 10443)
...
# Set Dropbear to listen on port 445
...
# (You should create similar scripts for SSH, Dropbear, Xray, Trojan, Hysteria management as needed)
# Ensure all scripts are executable
chmod +x /root/menu.sh

# =================== Final message ===================
echo "Setup complete! Use 'menu' command to manage your server."
echo "Client configs are stored in /root/ directories."
